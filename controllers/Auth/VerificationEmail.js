...
module.exports.SendMailVerify = async (emailReceiver, token, hostname)=>{
    ...
    <p style="line-height: 1.2; word-break: break-word; mso-line-height-alt: 14px; margin: 0;"> </p>
    <p style="line-height: 1.2; word-break: break-word; font-size: 14px; mso-line-height-alt: 17px; margin: 0;margin-left: 15px;"><span style="font-size: 14px;">Confirmation Link : </span></p>
    <p style="line-height: 1.2; word-break: break-word; font-size: 14px; mso-line-height-alt: 17px; margin: 0;margin-left: 15px;"><span style="font-size: 14px;">http://`+hostname+`/verification/`+emailHash+`/`+token+`</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    ...
    const mailOptions = {
        to: emailReceiver,
        from: 'Connect',
        subject: 'noreply: Verify your Email',
        html: data,
        attachments:[{
        ...
        },
        {
            ...
            path:__dirname + '../../../public/vendors/img/backdrop.png',
